...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 53238191, ; hash 0x32c59af, from name: EchoVid.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 202183678, ; hash 0xc0d13fe, from name: libaot-EchoVid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EchoVid.dll.so
		ptr null; void* handle (0x0)
	}, ; 18
	...
	%struct.DSOCacheEntry {
		i64 1902186134, ; hash 0x71610e96, from name: aot-EchoVid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EchoVid.dll.so
		ptr null; void* handle (0x0)
	}, ; 200
	...
	%struct.DSOCacheEntry {
		i64 1936561851, ; hash 0x736d96bb, from name: libaot-EchoVid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EchoVid.dll.so
		ptr null; void* handle (0x0)
	}, ; 205
	...
	%struct.DSOCacheEntry {
		i64 2992813638, ; hash 0xb262b646, from name: aot-EchoVid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EchoVid.dll.so
		ptr null; void* handle (0x0)
	}, ; 344
	...
	%struct.DSOCacheEntry {
		i64 3593440333, ; hash 0xd62f8c4d, from name: EchoVid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EchoVid.dll.so
		ptr null; void* handle (0x0)
	}, ; 407
