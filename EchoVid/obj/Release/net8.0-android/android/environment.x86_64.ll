...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 273125240702880530, ; hash 0x3ca55f59749cb12, from name: libaot-EchoVid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EchoVid.dll.so
		ptr null; void* handle (0x0)
	}, ; 7
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1009490203617158250, ; hash 0xe026dfdded6646a, from name: aot-EchoVid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EchoVid.dll.so
		ptr null; void* handle (0x0)
	}, ; 25
	...
	%struct.DSOCacheEntry {
		i64 4622299698191563445, ; hash 0x4025b515e41a7ab5, from name: EchoVid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EchoVid.dll.so
		ptr null; void* handle (0x0)
	}, ; 117
	...
	%struct.DSOCacheEntry {
		i64 6892005518409553170, ; hash 0x5fa55280ead55512, from name: libaot-EchoVid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EchoVid.dll.so
		ptr null; void* handle (0x0)
	}, ; 156
	...
	%struct.DSOCacheEntry {
		i64 10092642629944125398, ; hash 0x8c1044ffb2c8a7d6, from name: EchoVid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EchoVid.dll.so
		ptr null; void* handle (0x0)
	}, ; 254
	...
	%struct.DSOCacheEntry {
		i64 13895586907323937511, ; hash 0xc0d70aab949cb2e7, from name: aot-EchoVid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EchoVid.dll.so
		ptr null; void* handle (0x0)
	}, ; 359
...
@.env.3 = private unnamed_addr constant [37 x i8] c"e8e6de61-5173-42e9-8bc6-a39f4867d872\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.companyname.echovid\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-EchoVid.dll.so\00", align 16
